...
parser.add_argument('--annotation', type=str, default=r'./data/iu_xray/test.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'./data/iu_xray/images2', help="base dir to help find images")
...
parser.add_argument('--llama_model', default='/home/zhangwangjun/project/r2gengpt/llama27b', type=str, help="LLM model to use")
#parser.add_argument('--llama_model', default='/home/zhangwangjun/zwd/project/LLaMA-Factory-main/Meta-Llama-3-8B-Instruct', type=str, help="LLM model to use")
#parser.add_argument('--llama_model', default='/home/zhengweidong/projects/R2GenGPT/models/Qwen2.5-Coder-0.5B-Instruct-AWQ', type=str, help="LLM model to use")
